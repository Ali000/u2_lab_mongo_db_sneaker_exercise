...
```sh
db.products.find({color: {$in: ["Red", "White"]}})
```
...
```sh
db.products.insertMany([
  {model: '123', brand: "Nike", color: "Grey"},
  {model: "456", brand: "Nike", color: "Pink"},
  {model: "789", brand: "Nike", color: "Yellow"},
  {model: "321", brand: "Nike", color: "Green"}])
```
